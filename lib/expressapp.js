...
ExpressApp.prototype.start = function(opts, cb) {
  ...
  router.get('/v3/bizapp/:repo/discover/:name', function(req, res) {
    var server;
    var opts = {
  ...
  router.post('/v3/bizapp/:repo/latest', function(req, res) {
    var server;
    var opts = {
  ...
  router.get('/v3/bizapp/:repo/categories', function(req, res) {
    var server;
    var opts = {
      repo: req.params['repo']
    };
