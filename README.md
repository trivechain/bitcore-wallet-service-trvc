...
# bitcore-wallet-service-trvc

[![NPM Package](https://img.shields.io/npm/v/bitcore-wallet-service-trvc.svg?style=flat-square)](https://www.npmjs.org/package/bitcore-wallet-service-trvc)
[![Build Status](https://img.shields.io/travis/dashevo/bitcore-wallet-service-trvc.svg?branch=master&style=flat-square)](https://travis-ci.org/dashevo/bitcore-wallet-service-trvc)
[![Coverage Status](https://coveralls.io/repos/dashevo/bitcore-wallet-service-trvc/badge.svg?branch=master)](https://coveralls.io/r/dashevo/bitcore-wallet-service-trvc?branch=master)
...
# Getting Started
```
 git clone https://github.com/dashevo/bitcore-wallet-service-trvc.git
 cd bitcore-wallet-service-trvc && npm start
```
